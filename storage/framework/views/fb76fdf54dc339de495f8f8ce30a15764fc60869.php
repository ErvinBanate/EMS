        ...
        <div class="col-md-12">
            ...
            <form class="row g-3" method="POST" action="<?php echo e(route('store')); ?>">
                ...
                <div class="col-md-6">
                    ...
                    <input class="form-control" type="text" name="input-reported-by" value="<?php echo e(Auth::user()->name); ?>">
                </div>
                <div class="col-md-12">
                        ...
                        <?php if($report['reported_by'] == Auth::user()->name): ?>
                            <?php if($report['is_approved'] == 0 && $report['is_rejected'] == 0): ?>
                                <tr>
                                    ...
                                    <?php endif; ?>
                                    <td class="text-center"><a href="<?php echo e(route('show', ['reportId' => $report['id']])); ?>">Edit</a></td>
                                    <td class="text-center"><a href="<?php echo e(route('remove', ['reportId' => $report['id']])); ?>">Remove</a></td>
                                </tr>
                            <?php endif; ?>
                        <?php endif; ?>   
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmer/EMF/resources/views/employee/create.blade.php ENDPATH**/ ?>