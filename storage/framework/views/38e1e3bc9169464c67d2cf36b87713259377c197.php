                            ...
                            <?php if($report['is_approved'] == 1 && $report['is_rejected'] == 0): ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="<?php echo e(route('show', $report['id'])); ?>">View</a>
                                    </td>
                                </tr>
                            <?php endif; ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/elmer/EMF/resources/views/employeeFolder/home.blade.php ENDPATH**/ ?>